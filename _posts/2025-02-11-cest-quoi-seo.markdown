...
**Panda (2011)** — Google pénalise le contenu médiocre.

**Penguin (2012)** — Les backlinks de mauvaise qualité deviennent dangereux.

**Hummingbird (2013)** — Google comprend le sens des phrases, pas juste les mots-clés.
...
### SEO vs SEM vs Marketing Digital
...
## Les Fondamentaux du SEO (Ce que Tout le Monde Rate)
...
Exemple : au lieu de cibler "chaussures" (concurrence monstrueuse), ciblez "chaussures de running pour femmes à Antananarivo". Moins de monde le cherche — mais ceux qui le cherchent sont exactement vos clients.
...
- **Meta Description** — elle détermine si les gens cliquent.
- **Balises H1 et H2** — structurez votre contenu comme un plan logique.
- **Images** — compressez-les et ajoutez des attributs alt descriptifs.

### Étape 3 : Le SEO Technique

Là, on entre dans le dur. Mais c'est souvent ici que se cachent les gains les plus rapides.
...
- **Guest blogging** — écrire des articles invités sur des blogs pertinents
...
Avant de toucher quoi que ce soit, je comprends votre situation. Audit complet. Analyse de la concurrence. Identification des opportunités rapides.
...
**Un détail qui change tout :** j'intègre l'IA dans mon process — pour aller plus vite et anticiper les mises à jour des algorithmes.
...
- **Erreurs 404** — des pages mortes qui gaspillent votre budget de crawl
- **Contenu dupliqué** — deux pages qui parlent de la même chose se cannibalisent
...
- Temps de chargement rapide (sous 3 secondes)
...
Chaque page de votre site devrait avoir au moins un lien interne qui pointe vers elle.

**3. Réécrivez vos balises title**

Faites ce test : cherchez votre nom sur Google. Votre titre de page contient-il votre mot-clé principal ? Si non, corrigez ça maintenant.
...
Si vous êtes à Madagascar et que vous voulez sérieusement développer votre visibilité en ligne, je propose un **audit gratuit** pour vous montrer exactement où vous en êtes et ce qu'il faut faire en priorité.
...
Un lien provenant d'un site sérieux, pertinent par rapport à votre secteur, avec du vrai trafic.

**SEO on-page vs off-page : par quoi commencer ?**
Toujours commencer par l'on-page. Inutile de construire des liens vers un site qui n'est pas optimisé.

**Comment mesurer mes progrès ?**
Google Search Console (gratuit), Google Analytics (gratuit), et un outil comme SEMrush ou Ahrefs. Suivez : trafic organique, positions des mots-clés, taux de clics.

---

## Glossaire SEO

**Algorithme** — Les règles que Google utilise pour classer les sites.
...
**Contenu Dupliqué** — Du contenu identique sur plusieurs pages.

**Indexation** — Le processus par lequel Google analyse et enregistre votre page.

**Longue Traîne** — Des expressions de 3 mots ou plus. Moins cherchées, mais bien plus faciles à positionner.

**Maillage Interne** — L'ensemble des liens entre vos propres pages.

**SERP** — Search Engine Results Page. La page de résultats de Google.
