...
key_points:
  - "SEO = positions classiques dans les SERP ; GEO = citations dans les réponses des IA génératives"
  - "Le GEO ne remplace pas le SEO — les requêtes commerciales restent dans la logique SEO classique"
  - "Pas besoin de refonte : ajoutez des réponses directes en début d'article et du Schema FAQ — c'est l'essentiel"
  - "Un site peu autoritaire peut être cité en GEO sur des niches très spécifiques à Madagascar"
stats:
  - number: "1–3"
    label: "mois pour les premiers résultats GEO"
  - number: "50 %+"
    label: "des recherches avec AI Overview"
  - number: "2"
    label: "stratégies complémentaires"
---
